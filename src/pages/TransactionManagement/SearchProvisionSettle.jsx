...
import { getTransactionProvisionSettles } from '../../store/slices/transactionSlice';

const SearchProvisionSettle = () => {
  ...
  const [paymentStatusOption, setPaymentStatusOption] = useState(null);
  ...
  const handleSubmit = (values) => {
    ...
    const searchParams = {
      ...
      bankGuid: bankOption?.value || null,
      currencyGuid: currencyOption?.value || null,
      ravenTransactionTypeGuid: transactionTypeOption?.value || null,
      payOutStatusGuid: paymentStatusOption?.value || null,
    };
          ...
          {({ handleSubmit, handleChange, values, errors, touched }) => (
            <Form onSubmit={handleSubmit}>
              <Row>
                ...
                <Col md={3}>
                  <SelectField
                    ...
                    onChange={(option) => setPaymentStatusOption(option)}
                    placeholder={t('common.select')}
                  />
                </Col>
              </Row>
              ...
              <Row>
                ...
                <Col md={3}>
                  <Form.Group className="mb-3">
                    <Form.Label>{t('transaction.paymentDate')}</Form.Label>
                    <Form.Control
                      type="date"
                      name="paymentDate"
                ...
                <Col md={3}>
                  <Form.Group className="mb-3">
                    <Form.Label>{t('transaction.eodDate')}</Form.Label>
                    <Form.Control
                      type="date"
                      name="eodDate"
...
export default SearchProvisionSettle; 