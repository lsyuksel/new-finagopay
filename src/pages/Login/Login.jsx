  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      try {
        ...
        const errorMessage = error.response?.data?.message || t('errors.incorrectPassword');
                ...
                <Form onSubmit={formik.handleSubmit}>
                  ...
                  <Form.Group className="form-item">
                    ...
                    {formik.touched.email && formik.errors.email && (
                      <Message className='d-flex' severity="error" text={formik.touched.email && formik.errors.email} />
                    )}
                  ...
                  <Password 
                    ...
                    {formik.touched.password && formik.errors.password && (
                      <Message className='d-flex' severity="error" text={formik.touched.password && formik.errors.password} />
                    )}
                  </Form.Group>
                  ...
                  <Form.Group className="form-item">
                    <div className="d-flex align-items-center justify-content-between py-2">
                      ...
                      <div>
                        <Link to='/password' className="forgot-password">{t('common.forgotMyPassword')}</Link>
                      </div>
                    </div>
                  </Form.Group>
