...
import { passwordChangeConfirm, setPasswordChangeConfirmError } from '../../store/slices/passwordChangeConfirmSlice';
...
const token = queryParams.get('token');
  ...
  const { loading, error } = useSelector((state) => state.passwordChangeConfirm);
