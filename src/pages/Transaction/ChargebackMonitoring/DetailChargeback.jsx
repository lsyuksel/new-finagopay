...
import { getChargebackTransactionDetail } from '../../../store/slices/transaction-managment/chargeback-transaction-monitoring/chargebackTransactionDetailSlice';
...
export default function DetailChargeback() {
  ...
  const { loading, error, success, chargebackTransactionDetail } = useSelector((state) => state.chargebackTransactionDetail);

  useEffect(() => {
      if(param) dispatch(getChargebackTransactionDetail(param));
      console.log("chargebackTransactionDetail",chargebackTransactionDetail?.data1)
  }, [chargebackTransactionDetail])
              ...
              { !loading ? (
                  <>
                      <div className="datatable-area-container detail-page-table">
                          <DataTable 
                              header={header1}
                              value={chargebackTransactionDetail?.data1} 
                          ...
                          <DataTable 
                              value={chargebackTransactionDetail?.data2} 
                              emptyMessage={t('common.recordEmptyMessage')}
                              currentPageReportTemplate={t('common.paginateText')}
                              dataKey="guid"
                              scrollable
                      ...
                      <div className="datatable-area-container detail-page-table">
                          ...
                          <DataTable 
                              header={header3}
                              value={chargebackTransactionDetail?.data3} 
                              emptyMessage={t('common.recordEmptyMessage')}
                              currentPageReportTemplate={t('common.paginateText')}
                              dataKey="guid"
                              scrollable
                      ...
                      <div className="datatable-area-container detail-page-table">
                          <DataTable 
                              header={header4}
                              value={chargebackTransactionDetail?.data4} 
                              emptyMessage={t('common.recordEmptyMessage')}
                              currentPageReportTemplate={t('common.paginateText')}
                              dataKey="guid"
                              scrollable
